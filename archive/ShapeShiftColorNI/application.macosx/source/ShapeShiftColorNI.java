...
public class ShapeShiftColorNI extends PApplet {
...
class Mesh {
   ...
   // int sat = 100;
    ...
    if ( vertexNormals ) {
      for ( Iterator i = mesh.faces.iterator(); i.hasNext(); ) {
        ...
        //println("vertexBrightness: " + vertexBrightness );
  ...
  public void setVertexColor(PGraphics gfx, int c) {
    ...
    if(_drawLines){
      ...
      int lineColor = color( 0, 0, vertexBrightness);
...
public Pt[][] generateImagePoints(int res) {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--present", "--bgcolor=#666666", "--stop-color=#cccccc", "ShapeShiftColorNI" });
  }
}
